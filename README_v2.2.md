...
### Step 2: Verifica Clone (automatica)

Dopo la selezione della linea, il sistema mostra automaticamente:

| Scenario | Messaggio |
|----------|-----------|
| Clone Ventana | ✅ "Clone disponibile IN-HOUSE" |
| Clone Dako intercambiabile | ⚠️ "Alternativa SP263 disponibile (concordanza >90%)" |
| Clone Dako non intercambiabile | ⚡ "SERVICE ESTERNO obbligatorio" |
| PDL-1 non richiesto | ✅ "PDL-1 agnostico - nessuna IHC necessaria" |

### Step 3: Compilazione Anatomia Patologica

Se il clone è disponibile (in-house o intercambiabile), l'AP compila:
- 📈 **Score PDL-1** (TPS%, CPS%, o TC%/IC% separati)

### Step 4: Valutazione e Referto
